...
import { ArrowRight, Briefcase, CalendarText, Users } from 'lucide-react'; // Assuming these icons fit types of opportunities
...
export default function OpportunityCard({ title, description, type, link }: OpportunityCardProps) {
  ...
  const Icon = () => {
    switch(type) {
      ...
      case 'event': return <CalendarText className="h-6 w-6 text-primary" />;
